	...
	preserve 	
		...
		foreach v in "std_gpa_m" "std_gpa_c" "std_gpa_m_adj" "std_gpa_c_adj" "pass_math" "pass_read" {
			...
			twoway 		///(rarea miny maxy areax if inrange(areax, 2019.5, 2021.5), color(gs15)) ///
						...
						capture qui graph export "$FIGURES\Descriptive\raw_total_`level'_`v'${covid_data}.png", replace			
						capture qui graph export "$FIGURES\Descriptive\raw_total_`level'_`v'${covid_data}.pdf", replace	
