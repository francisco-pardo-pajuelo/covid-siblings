...
*/	
	...
	*- Cutoff at exam level
	egen id_cutoff_deprt 			= group(codigo_modular id_anio id_periodo_postulacion facultad 		type_admission 	source)
	egen id_cutoff_major 			= group(codigo_modular id_anio id_periodo_postulacion major_c1_code type_admission 	source)
	
	egen id_cutoff_deprt_full 		= group(codigo_modular id_anio id_periodo_postulacion facultad 						source)
	egen id_cutoff_major_full 		= group(codigo_modular id_anio id_periodo_postulacion major_c1_code 				source)	
