...
*- Enrollment outcomes:
	...
	*- Enrolled NOT IN STEM
	...
	label var enroll_uni_major_sib 	``s''"Enrolled in same university-major ever (sibling)"
...
isvar 			///
				...
				/*Sibling*/ ///
					...
					/*University*/ ///	
						/*Application */ 		year*app*sib app*sib semester_sib N_applications*sib score_std_*_avg_sib score_std_*_avg_uni_sib  /// score_std_major_avg_sib score_std_department_avg_sib
