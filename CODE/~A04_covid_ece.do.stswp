	...
	*- Achievement quartiles
	...
	foreach v in /*"std_gpa_m" "std_gpa_c"*/ "std_gpa_m_adj" "std_gpa_c_adj" /*"pass_math" "pass_read" "prim_on_time" "higher_ed_parent"*/ /*"approved" "approved_first"*/ {
		...
		estimates clear
			...
			//local size = "2_4"
				...
				//local subj = "m"
					eststo `v'_all0_`size'	: reghdfe `v' treated_post treated post, a(id_ie grade year pair)
					eststo `v'_all1_`size'	: reghdfe `v' treated_post treated post ${x_all}, a(id_ie grade year pair)
					eststo `v'_all2_`size'	: reghdfe `v' treated_post treated post ${x_all} ${x_score}, a(id_ie grade year pair)
					eststo `v'_all3_`size'	: reghdfe `v' treated_post treated post ${x_all} ${x_score} ${x_ses}, a(id_ie grade year pair)
	...
	local v = "std_gpa_m_adj"
			*- For Reviewing how adding controls affects the estimates
			coefplot ///
			(`v'_all0_2_4, mcolor(gs0) 	fcolor(gs0%20)	lcolor(gs0%20) 	ciopts(color(gs0))) ///
			, ///
			bylabel("No controls") ///
			|| ///
		...
		if "${covid_data}" == "" {
			...
			coefplot ///
			(`v'_all0_2, mcolor("${blue_1}") 	fcolor("${blue_1}%50")	lcolor("${blue_1}%50") 	ciopts(color("${blue_1}"))) ///
			(`v'_all0_3, mcolor("${red_1}") 		fcolor("${red_1}%50")	lcolor("${red_1}%50") 	ciopts(color("${red_1}"))) ///
			(`v'_all0_4, mcolor("${green_1}") 	fcolor("${green_1}%50")	lcolor("${green_1}%50") 	ciopts(color("${green_1}"))) ///
			, ///
			bylabel("No controls") ///
			|| ///
		...
		if "${covid_data}" == "" {
			...
			*- For heterogeneity with different sample splits
