	...
	foreach v in /*"std_gpa_m" "std_gpa_c"*/ "std_gpa_m_adj" "std_gpa_c_adj" /*"pass_math" "pass_read" "prim_on_time" "higher_ed_parent"*/ /*"approved" "approved_first"*/ {
		...
		estimates clear
			...
			//local size = "2_4"
				...
				//local subj = "m"
					eststo `v'_all1_`size'	: reghdfe `v' treated_post treated post, a(id_ie grade year pair)
					eststo `v'_all2_`size'	: reghdfe `v' treated_post treated post ${x_all}, a(id_ie grade year pair)
					eststo `v'_all3_`size'	: reghdfe `v' treated_post treated post ${x_all} ${x_score}, a(id_ie grade year pair)
					...
					eststo `v'_asp_low_`size'	: reghdfe `v' treated_post treated post ${x_all} ${x_score} ${x_ses} if inlist(base_aspiration,1,2)==1, a(id_ie grade year pair)
					//eststo `v'_asp_med_`size'	: reghdfe `v' treated_post treated post ${x_all} ${x_score} ${x_ses} if inlist(base_aspiration,3)==1, a(id_ie grade year pair)
					eststo `v'_asp_hig_`size'	: reghdfe `v' treated_post treated post ${x_all} ${x_score} ${x_ses} if inlist(base_aspiration,4,5)==1, a(id_ie grade year pair)
			
					//Effect by Expectations
					eststo `v'_asp2_low_`size'	: reghdfe `v' treated_post treated post ${x_all} ${x_score} ${x_ses} if inlist(base_aspiration,1,2,3,4)==1, a(id_ie grade year pair)
					//eststo `v'_asp_med_`size'	: reghdfe `v' treated_post treated post ${x_all} ${x_score} ${x_ses} if inlist(base_aspiration,3)==1, a(id_ie grade year pair)
					eststo `v'_asp2_hig_`size'	: reghdfe `v' treated_post treated post ${x_all} ${x_score} ${x_ses} if inlist(base_aspiration,5)==1, a(id_ie grade year pair)				
			restore
			}
		...
		*- For heterogeneity with different sample splits (4 groups)
		foreach sample_split in  "ses" /*"pc_int"*/ "acad" /*"asp"*/ {
			local v = "std_gpa_m_adj"
