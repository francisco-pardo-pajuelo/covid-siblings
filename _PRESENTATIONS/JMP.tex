...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item This translates into lower performance in standardized exams and lower expectations for higher education.
    \end{itemize}
...
%\cite{becker_child_1976},
    ...
    \item \textbf{School closures:} Significant learning losses around the world. Worse for vulnerable and longer closures. Family structure plays an import role.
...
\begin{frame}
    ...
    \frametitle{Siblings may compete for access to phone, TV, radio or computer}
       \begin{itemize}
           ...
           \item But households without resources show similar patterns 
       \end{itemize}
\end{frame}

\begin{frame}
    \label{frame:phoint}
    \frametitle{Similar effects with or without Phone with internet to fight for}
        {\resizebox{0.9\textwidth}{!}{
        \includegraphics{./FIGURES/TWFE/twfe_std_gpa_m_adj_byphoint_Tsiblings_Soldest_pairall_4.pdf}
      }
    }

    \begin{flushleft}
        \hyperlink{frame:phoint_siblings}{\beamergotobutton{Results by siblings}}
    \end{flushleft}    
...
\begin{frame}[T]
    ...
    \frametitle{India exhibits similar heterogeneity}
      ...
      \input{./TABLES/MANUAL/india_PRES.tex}
...
\begin{frame}
    \label{frame:phoint_siblings}
    \frametitle{Similar results for households with or without Phone with internet}
        {\resizebox{0.9\textwidth}{!}{
        %\includegraphics{./FIGURES/TWFE/covid_twfe_C_bysibs_elm_all_gpa_m_adj_Tsiblings_Soldest_4.pdf}
        \includegraphics{./FIGURES/TWFE/twfe_std_gpa_m_adj_byphoint_bysibs_Tsiblings_Soldest_pairall_4.pdf}
      }
    }

    \begin{flushleft}
        \hyperlink{frame:phoint}{\beamergotobutton{Go Back $\carriagereturn$}}
    \end{flushleft}       
