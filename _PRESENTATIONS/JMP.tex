...
%policy questions
    ...
    \begin{itemize}
        ...
        \item COVID-19 school closures forecast to cost up to \$17 trillion in lost lifetime earnings. (World Bank, UNESCO and UNICEF, 2021). There has been recovery due to natural catch-up or government assistance (50\% and 25\%) (\cite{singh_covid-19_2022}). It’s important to understand better how to effectively do that.
...
Do children with siblings experience larger learning losses when households face unexpected \textcolor{red}{shocks/school closures/increased childcare needs}?
\end{block}
}
    \end{itemize}
...
\begin{transitionframe}
    ...
    \item \textbf{Quantity-Quality:} Most papers find no reductions in quality of education with family size except with unexpected increases and vulnerable populations. {\tiny\cite{black_more_2005}, \cite{caceres-delpiano_impacts_2006} \cite{conley_parental_2006}}. {\tiny\cite{black_small_2010}, \cite{aslund_family_2010}.}
    \\ 
...
%\cite{becker_child_1976},
    \item \textbf{Health Shocks:} {\tiny\cite{adhvaryu_endowments_2016}}

    \item \textbf{School closures:} Significant learning losses around the world. Worse for vulnerable and longer closures.
    {\tiny \cite{haelermans_inequality_2022}, \cite{jakubowski_global_2023}, \cite{jack_pandemic_2023}, \cite{singh_covid-19_2022}, \cite{goldhaber_educational_2023}, \cite{lichand_impacts_2021} or \cite{lichand_lasting_2024}} I provide evidence on how family structure plays a role in this when more participation from parents becomes more valuable.
...
\begin{frame}
    ...
    \begin{itemize}
       \item Peru had the highest Covid death rate in the world: 6,600 per 1 million, 83\% higher than the US.
       \item Country-wide lockdown forbade  nonessential business operations. 
       \item School closures in public and private schools that lasted $\approx$ 2 years. 
...
\begin{transitionframe}
    \label{frame:learning_home}
    \frametitle{Learning from home}
    \begin{itemize}
       \item TVs were the most used resource in public schools ($\approx$ 75\%)
       \item There were 30 min time slots for each pair of grades were assignments were given.
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \only<1,5>{\color{black}}\only<2-4,6>{\color{gray!30}}Parental time dilution
...
\begin{frame}
    ...
    \begin{columns}[T]
        \begin{column}{0.45\textwidth}
            ...
            \hyperlink{frame:ece_trends}{\beamergotobutton{Data Trends}}
            ...
            \hyperlink{frame:parentaldilution_intro}{\beamergotobutton{Parental Dilution}} \\[2pt]
            \hyperlink{frame:byses}{\beamergotobutton{SES Analysis}}\\[2pt]
...
\begin{frame}
    ...
    %\input{./TABLES/MANUAL/twfe_ece_ses.tex}
     ...
     {\resizebox{0.9\textwidth}{!}{
        \includegraphics{./FIGURES/TWFE/twfe_ses_bysibs_2_4_8_Tsiblings_Soldest_4.pdf}
      }
    }
