...
\caption{Effect on younger sibling choices over STEM majors: Focal child applied to non-STEM and younger sibling is male}\label{tab:t_sib_heterog_stem_nstem_sm_all_bwfixed_2}
