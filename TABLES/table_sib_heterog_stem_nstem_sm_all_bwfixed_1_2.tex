...
\caption{Effect on younger sibling choices over STEM majors: Focal child applied to non-STEM and younger sibling is male}\label{tab:table_sib_stem_all_bwfixed_1_2}
