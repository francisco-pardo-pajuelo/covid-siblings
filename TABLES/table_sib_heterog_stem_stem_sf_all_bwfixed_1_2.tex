...
\caption{Effect on younger sibling choices over STEM majors: Focal child applied to STEM and younger sibling is female}\label{tab:table_sib_stem_all_bwfixed_1_2}
