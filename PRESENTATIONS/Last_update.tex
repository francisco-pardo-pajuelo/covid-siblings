...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            ...
            \end{itemize}
        \item Exogenous family size? Twin birth and birth order as instruments? $\approx$ 10k twins per grade-year.
...
\begin{frame}
    ...
    \frametitle{The distribution of gaps moves down}
       ...
       \includegraphics{./FIGURES/Descriptive/PISA_gap_PV1MATH_histogram_2009_2022.png}
      }
    }
\end{frame}
...
\begin{frame}
    ...
    \frametitle{Potential Mechanisms}
      \begin{itemize}
        \item Sibling Order Effect
            \begin{itemize}
                \item Effects are robust when focusing on first born
            \end{itemize}
        \item Sibling competition for material resources
            \begin{itemize}
                \item Effects are robust in households with/without internet, pc, etc.
                \item Effects are robust to different age gaps
            \end{itemize}
        \item Limited Parental Resources
            \begin{itemize}
                \item RD is a first approach, bur results not quite robust to smaller windows.
                \item Effects are not different for single parent households.
                \item Perhaps more detailed with Survey TWFE (Work? Income? Better measure of who lives in HH? Investment?)
            \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
 ...
 {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/TWFE/covid_twfe_A_all_all_gpa_m_adj_4.png}
      }
    }
\end{frame}
...
\begin{frame}
 ...
 {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/TWFE/covid_twfe_B_all_all_gpa_m_adj_4.png}
      }
    }
\end{frame}
...
\begin{frame}
 ...
 {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/TWFE/covid_twfe_sibs_C_elm_all_gpa_m_adj_4.png}
      }
    }
\end{frame}
...
\begin{frame}
 ...
 {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/TWFE/covid_twfe_D_all_all_gpa_m_adj_4.png}
      }
    }
\end{frame}
...
\begin{frame}
    ...
    \frametitle{Gaps are centered around 0}
        {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/Descriptive/PISA_gap_PV1MATH_histogram_2009_2012.png}
      }
    }
\end{frame}
...
\begin{frame}
 ...
 {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/RD_age/1_m_a_365_18_19.png}
      }
    }
\end{frame}
...
\begin{frame}
    ...
    \frametitle{Covid}
 {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/RD_age/K_m_a_365_20_21.png}
      }
    }
\end{frame}
...
\begin{frame}
 ...
 {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/RD_age/1_m_a_365_22_23.png}
      }
    }
\end{frame}
...
\begin{frame}
    ...
    \input{./TABLES/parental_investment_2p.tex}
\end{frame}

\begin{frame}
    \frametitle{Parental investment vs $\#$  of children - 8th grade}
    \input{./TABLES/parental_investment_2s.tex}
\end{frame}
