...
\begin{frame}
    ...
    \frametitle{\% of A's in Mathematics}
        {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/Event Study/raw_total_elm_pass_math.pdf}
      }
    }
\end{frame}
...
\begin{frame}
    ...
    \frametitle{Standardized GPA in Mathematics}
        {\resizebox{0.9\textwidth}{!}{
       \includegraphics{./FIGURES/Event Study/raw_total_elm_std_gpa_m_adj.pdf}
      }
    }
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        \item PISA
            ...
            \end{itemize}
        \item MICS + FL module (Foundations Learning Module) - UNICEF
            \begin{itemize}
                \item Basic knowledge to children 7-14 y.o.
                \item Wave 6 (2017-2023) asks about siblings. Some countries are surveyed before and some after covid.
                \item I look at cross country comparissons
            \end{itemize}
        \item TIMSS/PIRLS: No info on siblings
        \item NAEP: No info on siblings
        \item EGRA and EGMA: Couldn't find it?
        \item LLECE/ERCE (UNESCO)
        \item SEA‑PLM (UNICEF)
